 ...
 * on 2014-10-30 at 02:39:32 UTC 
 * Modify at your own risk.
 */

package com.mycompany.services.quoteendpoint;
...
public class Quoteendpoint extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @since 1.7
   */
  public static final String DEFAULT_ROOT_URL = "https://it3178quote.appspot.com/_ah/api/";
  ...
  public class GetQuote extends QuoteendpointRequest<com.mycompany.services.quoteendpoint.model.Quote> {
    ...
    protected GetQuote(java.lang.Long id) {
      super(Quoteendpoint.this, "GET", REST_PATH, null, com.mycompany.services.quoteendpoint.model.Quote.class);
   ...
   *
   * @param content the {@link com.mycompany.services.quoteendpoint.model.Quote}
   * @return the request
   */
  public InsertQuote insertQuote(com.mycompany.services.quoteendpoint.model.Quote content) throws java.io.IOException {
    InsertQuote result = new InsertQuote(content);
    initialize(result);
    return result;
  }

  public class InsertQuote extends QuoteendpointRequest<com.mycompany.services.quoteendpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected InsertQuote(com.mycompany.services.quoteendpoint.model.Quote content) {
      super(Quoteendpoint.this, "POST", REST_PATH, content, com.mycompany.services.quoteendpoint.model.Quote.class);
    }
  ...
  public class ListQuote extends QuoteendpointRequest<com.mycompany.services.quoteendpoint.model.CollectionResponseQuote> {
     ...
     */
    protected ListQuote() {
      super(Quoteendpoint.this, "GET", REST_PATH, null, com.mycompany.services.quoteendpoint.model.CollectionResponseQuote.class);
    }
  ...
  /**
   * Create a request for the method "listQuoteByAuthor".
   *
   * This request holds the parameters needed by the quoteendpoint server.  After setting any optional
   * parameters, call the {@link ListQuoteByAuthor#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public ListQuoteByAuthor listQuoteByAuthor() throws java.io.IOException {
    ListQuoteByAuthor result = new ListQuoteByAuthor();
    initialize(result);
    return result;
  }

  public class ListQuoteByAuthor extends QuoteendpointRequest<com.mycompany.services.quoteendpoint.model.CollectionResponseQuote> {

    private static final String REST_PATH = "quoteByAuthor";

    /**
     * Create a request for the method "listQuoteByAuthor".
     *
     * This request holds the parameters needed by the the quoteendpoint server.  After setting any
     * optional parameters, call the {@link ListQuoteByAuthor#execute()} method to invoke the remote
     * operation. <p> {@link ListQuoteByAuthor#initialize(com.google.api.client.googleapis.services.Ab
     * stractGoogleClientRequest)} must be called to initialize this instance immediately after
     * invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected ListQuoteByAuthor() {
      super(Quoteendpoint.this, "GET", REST_PATH, null, com.mycompany.services.quoteendpoint.model.CollectionResponseQuote.class);
    }
    ...
    @Override
    public ListQuoteByAuthor setAlt(java.lang.String alt) {
      return (ListQuoteByAuthor) super.setAlt(alt);
    }

    @Override
    public ListQuoteByAuthor setFields(java.lang.String fields) {
      return (ListQuoteByAuthor) super.setFields(fields);
    }

    @Override
    public ListQuoteByAuthor setKey(java.lang.String key) {
      return (ListQuoteByAuthor) super.setKey(key);
    }

    @Override
    public ListQuoteByAuthor setOauthToken(java.lang.String oauthToken) {
      return (ListQuoteByAuthor) super.setOauthToken(oauthToken);
    }

    @Override
    public ListQuoteByAuthor setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (ListQuoteByAuthor) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public ListQuoteByAuthor setQuotaUser(java.lang.String quotaUser) {
      return (ListQuoteByAuthor) super.setQuotaUser(quotaUser);
    }

    @Override
    public ListQuoteByAuthor setUserIp(java.lang.String userIp) {
      return (ListQuoteByAuthor) super.setUserIp(userIp);
    }
    ...
    public ListQuoteByAuthor setCursor(java.lang.String cursor) {
      this.cursor = cursor;
      return this;
    }
    ...
    public ListQuoteByAuthor setLimit(java.lang.Integer limit) {
      this.limit = limit;
      return this;
    }
    ...
    public ListQuoteByAuthor setAuthor(java.lang.String author) {
      this.author = author;
      return this;
    }

    @Override
    public ListQuoteByAuthor set(String parameterName, Object value) {
      return (ListQuoteByAuthor) super.set(parameterName, value);
    }
  }
   ...
   * @return the request
   */
  public UpdateQuote updateQuote(com.mycompany.services.quoteendpoint.model.Quote content) throws java.io.IOException {
    UpdateQuote result = new UpdateQuote(content);
    initialize(result);
    return result;
  }

  public class UpdateQuote extends QuoteendpointRequest<com.mycompany.services.quoteendpoint.model.Quote> {
     ...
     * @since 1.13
     */
    protected UpdateQuote(com.mycompany.services.quoteendpoint.model.Quote content) {
      super(Quoteendpoint.this, "PUT", REST_PATH, content, com.mycompany.services.quoteendpoint.model.Quote.class);
    }
